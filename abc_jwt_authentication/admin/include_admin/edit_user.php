...
//        move_uploaded_file($post_image_temp,"../images/$post_image");
        ...
        $query ="UPDATE user SET username='$username',password='$user_password', user_firstname='$user_firstname',user_lastname='$user_lastname',email='$user_email', user_role='$user_role' WHERE user_id=$user_id";
